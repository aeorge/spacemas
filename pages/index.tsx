        ...
        <main className='space-y-12 sm:space-y-24'>
          ...
          <section className='space-y-4 sm:space-y-8'>
            ...
            <p className='text-base sm:text-xl'>
              ...
              tempore aut mollitia sapiente suscipit. Nesciunt, aut quis
              veritatis aliquid voluptatum velit natus tempore unde. Similique
              deleniti perspiciatis possimus officiis reprehenderit saepe
              eveniet veniam labore?
            </p>
          </section>
